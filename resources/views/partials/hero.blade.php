            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div class="flex flex-col items-center text-center space-y-8">
                    ...
                    <div class="relative w-full flex justify-center items-center py-4 mb-20">
                        ...
                        <!-- Headline Text -->
                        <h1 class="relative z-10 w-full text-center text-[30px] min-[375px]:text-xs sm:text-3xl font-black tracking-tight font-display uppercase leading-tight text-slate-900 dark:text-white transition-colors duration-300">EXPERIENCE THE NEXT LEVEL OF FLAVOR</h1>
                    </div>
